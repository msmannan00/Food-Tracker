...
namespace Assets.SimpleFacebookSignIn.Scripts
{
    ...
    public class JWT
    {
        ...
        private const string JwksUri = "https://www.facebook.com/.well-known/oauth/openid/jwks/";
        ...
        /// <summary>
        /// More info: https://developers.facebook.com/docs/facebook-login/limited-login/token/validating
        ...
        public void ValidateSignature(string clientId, Action<bool, string> callback)
        {
            ...
            if ((string) payload["iss"] != "https://www.facebook.com")
            {
